            ...
            <div class="card shadow-lg border-0 rounded-4" style="background: linear-gradient(135deg, #e0e0e0 0%, #bdbdbd 100%); box-shadow: 0 8px 24px rgba(80,80,80,0.3), 0 1.5px 3px rgba(80,80,80,0.15);">
                ...
                <div class="card-body">
                    <div class="mt-4">
                        ...
                        <span class="badge me-2" style="background: #fdfdfdff; color: #de6868ff;">Author: {{ $post->user->name}}</span>
                        <span class="badge" style="background: #fdfdfdff; color: #de6868ff">Email :{{$post->user->email}} </span>
                        <span class=" badge" style="background: #fdfdfdff; color: #de6868ff;">Last Updated :{{ \Carbon\Carbon::parse($post["created_at"])->format('F j, Y, g:i a') }}</span>
                    </div>
                    <hr>
